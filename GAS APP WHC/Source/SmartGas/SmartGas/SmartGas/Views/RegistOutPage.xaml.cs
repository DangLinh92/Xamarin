...
namespace SmartGas.Views
{
    ...
    public partial class RegistOutPage : ContentPage
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistInOutPage" /> class.
        /// </summary>
        public RegistOutPage()
        {
        ...
        protected override void OnAppearing()
        {
            if (Application.Current.Resources.ContainsKey("QrCode"))
            {
                ...
                (BindingContext as RegistOutViewModel).QR_Code = qrCode;
            }
        }

        protected override bool OnBackButtonPressed()
        {
            (BindingContext as RegistOutViewModel).ClearData();
