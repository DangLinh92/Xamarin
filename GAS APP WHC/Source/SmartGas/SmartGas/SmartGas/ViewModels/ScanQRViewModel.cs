...
namespace SmartGas.ViewModels
{
    ...
    public class ScanQRViewModel : BaseViewModel
    {
        ...
        private static ScanQRViewModel noVideosPageViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="ScanQRViewModel" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the value of no videos page view model.
        /// </summary>
        public static ScanQRViewModel BindingContext =>
            noVideosPageViewModel = PopulateData<ScanQRViewModel>("errorAndEmpty.json");

        /// <summary>
        /// Gets or sets the ImagePath.
        /// </summary>
        [DataMember(Name = "noVideosImagePath")]
        ...
        /// </summary>
        [DataMember(Name = "noVideosHeader")]
        ...
        /// </summary>
        [DataMember(Name = "noVideosContent")]
        ...
        private async void GoBack(object obj)
        {
            ...
            string qrCode = label.Text;
            if (!string.IsNullOrEmpty(qrCode))
            {
                Application.Current.Resources["QrCode"] = qrCode;
            }
